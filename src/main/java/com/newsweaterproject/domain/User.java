...
//fetch = FetchType.EAGER подгрузка базы происходит сразу
    @CollectionTable(name = "user_role", joinColumns = @JoinColumn(name = "user_id"))
//то в какой таблице будет хранится наш Сет и объединение происходит с нашей таблицей в таблице усер ид
